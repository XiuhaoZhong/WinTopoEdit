...
public:
	...
	void ShowProperies(ITedPropertyInfo *pPropertyInfo);
	void ClearProperties();

	void OnFinalMessage(HWND hwnd);

	LRESULT OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL &bHandled);
	LRESULT OnEraseBkgId(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL &bHandled);
...
protected:
	BEGIN_MSG_MAP(CPropertyEditWindow)
		...
		MESSAGE_HANDLER(WM_ERASEBKGND, OnEraseBkgId)
